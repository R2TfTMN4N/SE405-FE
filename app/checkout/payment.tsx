      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <ThemedView style={styles.statusBar}>
          <Svg width="280" height="39" viewBox="0 0 280 39" fill="none">
            <Path
              d="M34.6004 6.94C34.6004 7.48 34.3104 7.97 33.8504 8.22L32.1104 9.16L30.6304 9.95L27.5604 11.61C27.2304 11.79 26.8704 11.88 26.5004 11.88C26.1304 11.88 25.7704 11.79 25.4404 11.61L19.1504 8.22C18.6904 7.97 18.4004 7.48 18.4004 6.94C18.4004 6.4 18.6904 5.91 19.1504 5.66L21.1204 4.6L22.6904 3.75L25.4404 2.27C26.1004 1.91 26.9004 1.91 27.5604 2.27L33.8504 5.66C34.3104 5.91 34.6004 6.4 34.6004 6.94Z"
              fill={Colors[scheme].tint}
            />
            <Path
              d="M24.3997 12.7901L18.5497 9.87014C18.0997 9.64014 17.5797 9.67014 17.1497 9.93014C16.7197 10.1901 16.4697 10.6501 16.4697 11.1501V16.6801C16.4697 17.6401 16.9997 18.5001 17.8597 18.9301L23.7097 21.8501C23.9097 21.9501 24.1297 22.0001 24.3497 22.0001C24.6097 22.0001 24.8697 21.9301 25.0997 21.7801C25.5297 21.5201 25.7797 21.0601 25.7797 20.5601V15.0301C25.7897 14.0801 25.2597 13.2201 24.3997 12.7901Z"
              fill={Colors[scheme].tint}
            />
            <Path
              d="M36.53 11.1501V16.6801C36.53 17.6301 36 18.4901 35.14 18.9201L29.29 21.8501C29.09 21.9501 28.87 22.0001 28.65 22.0001C28.39 22.0001 28.13 21.9301 27.89 21.7801C27.47 21.5201 27.21 21.0601 27.21 20.5601V15.0401C27.21 14.0801 27.74 13.2201 28.6 12.7901L30.75 11.7201L32.25 10.9701L34.45 9.87013C34.9 9.64013 35.42 9.66013 35.85 9.93013C36.27 10.1901 36.53 10.6501 36.53 11.1501Z"
              fill={Colors[scheme].tint}
            />
            <Path
              d="M32.1101 9.16L30.6301 9.95L21.1201 4.6L22.6901 3.75L31.8701 8.93C31.9701 8.99 32.0501 9.07 32.1101 9.16Z"
              fill={Colors[scheme].tint}
            />
            <Path
              d="M32.25 10.9702V13.2402C32.25 13.6502 31.91 13.9902 31.5 13.9902C31.09 13.9902 30.75 13.6502 30.75 13.2402V11.7202L32.25 10.9702Z"
              fill={Colors[scheme].tint}
            />
            <Path
        ...
        <FullButton
          ...
          onPress={() => {
            if (!paymentMethod) {
              toast.show({
                message: t("checkoutPayment.selectPaymentMethod"),
                type: "error",
              });
              return;
            }
