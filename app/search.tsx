...
const SearchScreen: React.FC = () => {
  ...
  const handleApplyFilters = () => {
    ...
    if (
      typeof draftFilters.minPrice === "number" &&
      draftFilters.minPrice > PRICE_RANGE.min
    ) {
    ...
    if (
      ...
      draftFilters.maxPrice < PRICE_RANGE.max
    ) {
      ...
      <ThemedView>
        ...
        >
          <TextInput
            ...
            style={[
              styles.searchInput,
              { color: palette.text, backgroundColor: palette.background },
            ]}
            value={value}
